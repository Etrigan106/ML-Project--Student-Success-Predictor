...
ASSETS_PATH = OUTPUT_PATH / Path(r"C:\Users\theul\OneDrive\Desktop\Advance Python Course\ML Project (Student Success Predictor)\Code\assets 1\frame0")
...
button_5 = Button(
    ...
    borderwidth=0,
    highlightthickness=0,
    command=lambda: #Prediction_Calculator(),
